...
class IdeasTasksScreen extends StatefulWidget {
  IdeasTasksScreen({Key? key}) : super(key: key);

  @override
  State<IdeasTasksScreen> createState() => _IdeasTasksScreenState();
}

class _IdeasTasksScreenState extends State<IdeasTasksScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final Stream<QuerySnapshot> _tasksStream = FirebaseFirestore.instance
        ...
        .doc(uid)
        .collection(Strings.ideasTasksCollection)
        .snapshots();
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: TitleText(text: 'Ideas Tasks'),
        centerTitle: true,
      ),
      body: Container(
        height: height,
          ...
          builder:
            ...
            return ListView(
              ...
              return TaskCard(
                ...
                taskId: data['taskId'],
                categoryName: Strings.ideasTasksCollection,
              );
            }).toList());
          },
        ),
        ...
        onPressed: () {
          showModalBottomSheet(
            ...
            builder: (BuildContext context) => AddTaskModalSheet(
              ...
              category: Strings.ideasTasksCollection,
            ),
          );
        },
        child: Icon(
