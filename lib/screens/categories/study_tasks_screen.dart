...
class StudyTasksScreen extends StatefulWidget {
  StudyTasksScreen({Key? key}) : super(key: key);
...
class _StudyTasksScreenState extends State<StudyTasksScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final Stream<QuerySnapshot> _tasksStream = FirebaseFirestore.instance
        ...
        .doc(uid)
        .collection(Strings.studyTasksCollection)
        .snapshots();
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: TitleText(text: 'Study Tasks'),
        centerTitle: true,
      ),
      body: Container(
        height: height,
          ...
          builder:
            ...
            return ListView(
              ...
              return TaskCard(
                ...
                taskId: data['taskId'],
                categoryName: Strings.studyTasksCollection,
              );
            }).toList());
          },
        ),
        ...
        onPressed: () {
          showModalBottomSheet(
            ...
            builder: (BuildContext context) => AddTaskModalSheet(
              ...
              category: Strings.studyTasksCollection,
            ),
          );
        },
        child: Icon(
