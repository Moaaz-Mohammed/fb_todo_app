...
class VacationTasksScreen extends StatefulWidget {
  VacationTasksScreen({Key? key}) : super(key: key);

  @override
  State<VacationTasksScreen> createState() => _VacationTasksScreenState();
}

class _VacationTasksScreenState extends State<VacationTasksScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final Stream<QuerySnapshot> _tasksStream = FirebaseFirestore.instance
        ...
        .doc(uid)
        .collection(Strings.vacationTasksCollection)
        .snapshots();
    return Scaffold(
          ...
          builder:
            ...
            return ListView(
              ...
              return TaskCard(
                ...
                taskId: data['taskId'],
                categoryName: Strings.vacationTasksCollection,
              );
            }).toList());
          },
        ),
        ...
        onPressed: () {
          showModalBottomSheet(
            ...
            builder: (BuildContext context) => AddTaskModalSheet(
              ...
              category: Strings.vacationTasksCollection,
            ),
          );
        },
        child: Icon(
