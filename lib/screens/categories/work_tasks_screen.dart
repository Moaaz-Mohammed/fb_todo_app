...
class WorkTasksScreen extends StatefulWidget {
  WorkTasksScreen({Key? key}) : super(key: key);
...
class _WorkTasksScreenState extends State<WorkTasksScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final Stream<QuerySnapshot> _tasksStream = FirebaseFirestore.instance
        ...
        .doc(uid)
        .collection(Strings.workTasksCollection)
        .snapshots();
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: TitleText(text: 'Work Tasks'),
        centerTitle: true,
      ),
      body: Container(
        height: height,
          ...
          builder:
            ...
            return ListView(
              ...
              return TaskCard(
                ...
                taskId: data['taskId'],
                categoryName: Strings.workTasksCollection,
              );
            }).toList());
          },
        ),
        ...
        onPressed: () {
          showModalBottomSheet(
            ...
            builder: (BuildContext context) => AddTaskModalSheet(
              ...
              category: Strings.workTasksCollection,
            ),
          );
        },
        child: Icon(
