...
class EntertainmentTasksScreen extends StatefulWidget {
  EntertainmentTasksScreen({Key? key}) : super(key: key);

  @override
  State<EntertainmentTasksScreen> createState() =>
      _EntertainmentTasksScreenState();
}

class _EntertainmentTasksScreenState extends State<EntertainmentTasksScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final Stream<QuerySnapshot> _tasksStream = FirebaseFirestore.instance
        ...
        .doc(uid)
        .collection(Strings.entertainmentTasksCollection)
        .snapshots();
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: TitleText(text: 'Entertainment Tasks'),
        centerTitle: true,
      ),
      body: Container(
        height: height,
          ...
          builder:
            ...
            return ListView(
              ...
              return TaskCard(
                ...
                taskId: data['taskId'],
                categoryName: Strings.entertainmentTasksCollection,
              );
            }).toList());
          },
        ),
        ...
        onPressed: () {
          showModalBottomSheet(
            ...
            builder: (BuildContext context) => AddTaskModalSheet(
              ...
              category: Strings.entertainmentTasksCollection,
            ),
          );
        },
        child: Icon(
